package com.example.assigment_longmt.Adapter;
...
public class YeuThichAdapterRC extends RecyclerView.Adapter<YeuThichAdapterRC.ItemHolder> {

    private Context context;
    private List<Photo> photoList;

    public YeuThichAdapterRC(Context context, List<Photo> photoList) {
    ...
    public ItemHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_photolove, viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull ItemHolder itemHolder, int i) {
        ...
        final Thread myThread = new Thread(new Runnable() {
            @Override
            public void run() {
                Bitmap bitmap = loadImageFromNet(photo.getUrlC());
